        ...
        <div className="container">
          <div className="row gx-lg-5 align-items-center">
            <div className="col-lg-6 mb-5 mb-lg-0">
              ...
              <br/><br/><br/> <strong className="d-flex justify-content-center">User credential </strong> <br/>
              <strong className="d-flex justify-content-start">Email :midhunkumarengineer98@gmail.com</strong>
              <br/><strong className="d-flex justify-content-start">Password  :12345678</strong>
              </p>
            </div>
